...
class _OrderScreenState extends State<OrderScreen>
  ...
  final List<String> _tabs = ['Active Rides', 'Completed', 'Cancelled'];
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<int>(
                          ...
                          icon: Container(
                            padding: const EdgeInsets.all(4),
                            decoration: BoxDecoration(
                              color: AppColors.moroccoRed.withOpacity(0.10),
                      ...
                      children: [
                                                ...
                                                children: [
                                                                ...
                                                                children: [
                                                                  Expanded(
                                                                    child: Row(
                                                                      children: [
                                                                        Text(
                                                                            orderModel.someOneElse!.fullName
                                                                                .toString()
                                                                                .tr,
                                                                            style:
                                                                                GoogleFonts.poppins()),
                                                                        Text(
                                                                            orderModel.someOneElse!.contactNumber
                                                                                .toString()
                                                                                .tr,
                                                                            style:
                                                  ...
                                                  Visibility(
                                                      ...
                                                      child: ButtonThem
                                                        ...
                                                        context,
                                                        title:
                                                            "View Drivers (${orderModel.acceptedDriverId != null ? orderModel.acceptedDriverId!.length.toString() : "0"})"
                                                                .tr,
                                                        btnHeight: 44,
                                                        onPress: () async {
                                                          Get.to(
                                                          ...
                                                          onSelected:
                                                            ...
                                                            if (value == 1) {
                                                              ...
                                                              if (driver !=
                                                                ...
                                                                2) {
                                                              // ── Call Logic
                                                              // Call logic is now handled by the ZegoSendCallInvitationButton in the menu
                                                            } else if (value ==
                                                                3) {
                                                              // ── Map Logic
                                                              if (Constant
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (BuildContext context,
                            ...
                            return snapshot.data!.docs.isEmpty
                                ? Center(
                                    child: Text("No cancelled rides found".tr),
                                  )
                                : ListView.builder(
                                    itemCount: snapshot.data!.docs.length,
                                    scrollDirection: Axis.vertical,
